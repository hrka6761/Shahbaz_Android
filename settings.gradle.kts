...
include(":core:flight_contracts")
include(":core:flight_controller")
include(":core:autopilot")
include(":core:remote_pilot")
include(":core:flight_black_box")
include(":feature:map:impl")
include(":feature:dashboard:impl")
include(":feature:settings:impl")
include(":feature:reports:impl")
include(":feature:report_details:impl")
